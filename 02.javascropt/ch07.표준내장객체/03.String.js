...
console.log(str.concat('여려분'));   //안녕하세요? + 여려분
...
console.log(newStr);
//한글과 공백만 남기고 모두 제거
newStr = sample.replace(/[^ㄱ-ㅎ ㅏ-ㅣ 가-힣 ]/g,''); // "^"표시는 남기고 모두 제거
console.log(newStr);
...
console.log(today);
//2023-03-20T06:56:04.715Z
console.log(today.substring(0,10));   //날짜만 추출 2023-03-20
console.log(today.substring(11,19));  //시간 추출 06:57:28
console.log(new Date().getHours());   //시간만 추출 16
...
let now = myDatetime();            //2023-03-2016:11:45
console.log(now.substring(2));     //23-03-2016:12:18  두번째 인수를 생략하면 맨 끝까지
